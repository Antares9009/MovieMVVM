...
const val API_KEY = "9f6c3d84f781a5abd066dda6531609f1"
...
object TheMovieDBClient {
    ...
    fun getClient(): TheMovieDBInterface{
        ...
        val requestInterceptor = Interceptor { chain ->
            ...
            return@Interceptor chain.proceed(request) //explicitly return a value from whit @ annotation. lamda always returns the value of lambda
        }
